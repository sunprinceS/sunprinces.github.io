...
map:
  ...
  - title: "Tower Bridge"
    ...
    完全暗下來後還比較好看，在橋下跟拿著大砲跟神秘水晶球 🔮 的攝影師一起等待那絕佳的時刻也是很特別的體驗 📸"
  - title: "ART ❓ "
    lat: '48.8608'
    lng: '2.3522'
    img: 'Pompidou.jpg'
    date: "October 2017"
    desc: "📍 龐畢度藝術中心 (Centre Georges-Pompidou)。藝術是比工程還高的事物，工程是有所局限的，而之所以現在成為顯學，是因為滿足時代的需要，最基本的需要，但像美學、文學這種或許不那麼容易養活一個人的學問，卻是更貼近人性、帶來更高層次的滿足"
  - title: "塔林老城"
    lat: '59.4389'
    lng: '24.7403'
    img: 'Tallinn.jpg'
    date: "September 2017"
    desc: "環繞的古城牆，斑駁卻依然矗立的塔樓 🏰 ，散發濃濃的古風，間或身著中世紀服裝者從身旁走過，令人不禁會心一笑。外圍海域並無防禦性小島作為防線的塔林位處前線，理所當然該有這些防禦設施"
  ...
  - title: '皇族獵場 - 動物園島'
    ...
    date: "August 2017"
    desc: "📍 Djurgården。那天翹了 A1 Swedish，參觀完歷史博物館後，順道步行至曾經是皇族獵場，現在則是供各種動物們做日光浴的動物園島。瑞典的夏日是十分愜意的，午後剛剛好的陽光，讓人不自覺就繞島了一周 🍹"
  - title: 'Kayak 初體驗 🛶 '
    lat: '59.3230'
    lng: '18.0456'
  ...
  - title: '交換的第一次出國旅行 🎒'
    ...
    img: 'Copenhagen.jpg'
    date: "August 2017"
    desc: "📍 Nyhavn, Copenhagen 第一次出國 (aka 出瑞典 😆 )，嘗試了只花 20 丹麥克朗過完 3 天的極限窮遊，那 20 kr 還是因為要投置物櫃才獲得的，不然打算直接 0 元走跳哥本哈根 （有體驗就好，下不為例 😂 ）"
  - title: 'Kaunas 街拍'
    lat: '54.8981'
    lng: '23.8974'
    img: 'Kaunas.jpg'
  ...
  - title: '⛪ 聖依納爵堂 - 壁畫'
    ...
    img: "Rome_church.jpg"
    date: "October 2017"
    desc: "走進教堂，光線從穹頂的天窗透入，道道金黃光芒四散，落於殿內的祭壇上。側廊樑柱上的浮雕精緻細膩，即便是在那翻飛的頂端亦如是，而天花板上的壁畫精彩程度也不遑多讓，訴說著神與神、神與人、人與人之間千年來的故事"



---

{{< world_journey resize_options="x150" >}}
